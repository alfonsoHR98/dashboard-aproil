...
<div class="animate__animated anumate__fadeInRight">
  <h1 class="logo">Sección de <span>Proveedores</span></h1>
  <div class="information-content">
    ...
    <table class="table_id">
      ...
      <tbody>
        <?php
          $sql_proveedores = "SELECT * FROM provedores";
          $datos_proveedores = mysqli_query($conn, $sql_proveedores);
          if ($datos_proveedores -> num_rows > 0) {
            while ($fila = mysqli_fetch_array($datos_proveedores)) {
        ?>
        <tr>
          ...
          <td>
            <a id="btn-abrir-editar" href="proveedores/editar.php?id=<?php echo $fila['id_provedor']?>" ><i class='bx bxs-edit' ></i></a>
            <a id="btn-abrir-eliminar" href="proveedores/eliminar.php?id=<?php echo $fila['id_provedor']?>" ><i class='bx bx-trash'></i></a>
          </td>
          <?php
              }
            }
